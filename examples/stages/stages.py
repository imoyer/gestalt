...
#	stages.uvNode.loadProgram('../../../086-005/086-005a.hex')
	...
	stages.move([10,10,10,10],0)
	mstatus = stages.xAxisNode.spinStatusRequest()
	while mstatus['stepsRemaining'] > 0:
		time.sleep(0.1)
		mstatus = stages.xAxisNode.spinStatusRequest()
	...
	#time.sleep(1)
	#print "x"
	#stages.move([0,0,0,0],0)
	#time.sleep(1)
	#print "x"
	#stages.move([0,0,0,0],0)
	#time.sleep(1)
	#print "x"
	#stages.move([10,0,0,0],0)
	#time.sleep(1)
	#print "y"
	##stages.move([0,10,0,0],0)
	#time.sleep(1)
	#print "y"
	#stages.move([0,10,0,0],0)
	#time.sleep(1)
	#print "y"
	#stages.move([0,0,10,0],0)
	#time.sleep(1)
	#print "u"
	#stages.move([0,0,10,0],0)
	#time.sleep(1)
